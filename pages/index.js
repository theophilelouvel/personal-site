    ...
    return <>
        ...
        <Layout>
            <header>
                ...
                <p className="dark:text-bluegray-200 mb-10">I have a special interest in algorithms, embedded programming, backend development and web development in general, which I try to learn more about day in and day out to later share my journey here.</p>
            </header>
            <main>
                {posts.map((post) => (
