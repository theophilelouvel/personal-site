...
Befored that I used to operate as a translator, which to me is really just one thing!

The only difference being now I translate to computer languages instead.
