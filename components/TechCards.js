            ...
            {techs &&
                techs.map(({ name, src, href }) => (
                    <a key={name} href={href} target="_blank">
                        <div className="flex flex-col items-center justify-center h-28 w-24 md:h-32 md:w-28 flex-shrink-0 rounded-lg m-2 py-2 focus:outline-none shadow-md hover:shadow-lg dark:bg-bluegray-200">
