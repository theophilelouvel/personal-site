        ...
        <ul className="bg-bluegray-50 rounded-3xl p-2 sm:p-5 xl:p-6 dark:bg-bluegray-800">
            {
                milestones.map((m, i) => (
                    <li key={"milestone_" + i}>
                        <article className="hover:bg-white rounded-xl dark:hover:bg-bluegray-700">
                            <a href={m.link} target="_blank" className="grid lg:grid-cols-8 xl:grid-cols-9 items-start relative rounded-xl p-3 sm:p-5 xl:p-6 overflow-hidden ">
